...
# This file is taken from the original konto_check gem (Copyright (C)
# Michael Plugge, LGPL 2.1 or later) and was modified for konto_check_ruby
# by tickettoaster GmbH in September 2026: it now requires the pure Ruby
# KontoCheckRaw module instead of the C extension; the functions are
# otherwise unchanged.
# vi: ft=ruby:set si:set fileencoding=UTF-8

# KontoCheckRaw is provided by konto_check_ruby (pure Ruby port), see raw.rb
require_relative 'raw'

#This is the Ruby-like interface of konto_check_ruby, a pure Ruby port of
#the C library konto_check to check the validity of German Bank Account
#Numbers. The module is taken from the original konto_check gem (LGPL) and
#works unchanged on top of the pure Ruby KontoCheckRaw module. All currently defined test methods by Deutsche Bundesbank
